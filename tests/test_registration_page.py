...
class TestRegistrationPage:
	...
	def test_registration_success(self, driver, generate_email, generate_password):
		...
		driver.find_element(*Locators.EMAIL_INPUT_FIELD).send_keys(generate_email)
		driver.find_element(*Locators.PASSWORD_INPUT_FIELD).send_keys(generate_password)
	...
	def test_negative_empty_field_name_not_submitted(self, driver, generate_email, generate_password):
		driver.find_element(*Locators.SIGN_IN_ACCOUNT_BUTTON).click()
